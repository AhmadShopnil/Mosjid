...
// export default function SidebarForBooks({ setIsDrawerOpen, books }) {
//   const {
//     selectedBooks,
//     setSelectedBooks,
...
//     return {
//       // keeps only one expanded book or chapter
//       [itemKey]: !isOpen
//     };
//   });
// };
...
//     // console.log("from sidebar",chapter)


//     setSelectedBooks(book);
//     setSelectedChapter(chapter); // resets section
//     console.log("from sidebar", chapter)

//     toggleExpand(`chapter-${chapter.id}`);

//     if (setIsDrawerOpen) setIsDrawerOpen(false);

//     // router.push(`/fatwa?book=${book.id}&chapter=${chapter.id}`);
//   };
...
//         {books?.map((book) => {
//           const isBookExpanded = expandedItems[book.id];
...
//                 className={`group w-full max-h-[70px] px-4 py-3 flex items-center gap-3 transition-all
//                   ${isBookExpanded ||
//                     hovered === book.id ||
...
//                   alt={book?.name_en}
//                   className={`w-[42px] h-[42px] object-contain transition
//                   ${isBookExpanded ||
//                       hovered === book.id ||
//                       selectedBooks?.id === book.id
//                       ? "brightness-0 invert"
