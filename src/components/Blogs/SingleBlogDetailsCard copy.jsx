    ...
    return (
        <div className=" bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
            ...
            <div className="flex justify-between items-center bg-gradient-to-b from-[#EEF8E9] to-[#BAFF98] px-4 py-4 gradient-border-bottom">
                ...
                <div className='bg-[#00401A] text-white h-[56px] rounded-[50px] w-[168px] flex justify-center items-center text-sm sm:text-base md:text-[22px]'>
            ...
            {/* Footer */}
            <div className="flex flex-col md:flex-row justify-between items-center  bg-gradient-to-b from-[#EEF8E9] to-[#BAFF98] px-4 py-4 ">
                <p
