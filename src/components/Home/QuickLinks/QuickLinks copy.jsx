...
//                 <div
//                   className={`quicklinks  flex flex-col w-[200px] h-[200px] items-center justify-center rounded-[30px] 
//                     py-3.5 cursor-pointer text-center transition-all duration-200 ${isHovered
//                       ? " text-white shadow-lg"
//                       : "bg-white text-[#00401A] shadow"
//                     }`}
//                   // className={`quicklinks  flex flex-col w-[200px] h-[200px] items-center justify-center rounded-[30px] py-3.5 cursor-pointer text-center transition-all duration-200 ${isHovered
