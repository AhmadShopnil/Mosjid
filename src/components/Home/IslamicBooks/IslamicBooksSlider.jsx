...
export default function IslamicBooksSlider({ books, islamic_books_ExtraData }) {
  ...
  const find_more_books_button =
    islamic_books_ExtraData?.custom_information?.find(
      (item) => item.label === "find_more_books_button"
    );
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between mb-6">
              <div>
                <div className="flex justify-between items-center gap-2 gradient-border_b mb-4 sm:mb-0 pb-3">
                  <Image src={icon} alt="Book Icon" width={62} height={64} />
            ...
            <div className="relative">
              ...
              <motion.div
                ...
                variants={{
                  ...
                  visible: {
                    transition: {
                      staggerChildren: 0.15, // stagger each book card
                    },
                  },
                }}
              >
