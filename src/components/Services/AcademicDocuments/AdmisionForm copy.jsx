...
//       });
//       console.log("response admission", response)
//       if (response.data) {
...
//             <FileInput label="Copy of ID or Passport" name="copy_id_passport" onChange={handleChange} required />
//             <FileInput label="Recent Photograph" name="photo" onChange={handleChange} required />
//             <FileInput label="Previous School Certificate" name="pre_schools_certificate" onChange={handleChange} required />
//             <FileInput label="Health Certificate" name="health_certificate" onChange={handleChange} required />
//           </div>
//         </div>
...
//             <FileInput label="Signature of Parent / Guardian" name="signature" onChange={handleChange} required />
//             <div className="flex items-end pb-2">
//               <label className="flex items-center gap-2 cursor-pointer">
//                 <input type="checkbox" required className="w-5 h-5 accent-green-600" />
//                 <span className="text-sm">I agree to the school policies and declaration.</span>
//               </label>
//             </div>
//           </div>
//         </div>
