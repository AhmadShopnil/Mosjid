                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    >
                        <p className="text-[#B98C20] text-base mt-2">
                            Welcome to the House of Allah. We ask all visitors to uphold modesty, respect,
                            and cleanliness during their time in the Masjid.
                        </p>
