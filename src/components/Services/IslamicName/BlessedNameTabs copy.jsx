...
// console.log("blesed name",categories)
...
//               className={`px-5 py-2 lg:py-2.5 lg:px-7 rounded-[13px] border text-[12px] lg:text-[16px] font-medium transition cursor-pointer
//                 ${
//                   isActive
...
//              <span> {cat?.name}</span>
//              <br />
//               <span className="text-[#F7BA2A] font-semibold text-[10px] lg:text-[14px]"> {cat?.description}</span>
//             </button>
//           );
//         })}
//       </div>
