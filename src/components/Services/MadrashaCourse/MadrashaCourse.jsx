...
export default function MadrashaCourse({ madrasha_course_data }) {
    ...
    const maktab_nazirah_foundation = sections?.find((s) => s.title_slug === "maktab-nazirah-foundation");
      const nazirah_hifz_continuation = sections?.find((s) => s.title_slug === "nazirah-hifz-continuation");
        ...
        <div className=" px-1 h-auto">
            ...
            <div className="mt-10 border-2 border-[#FFCE4D] rounded-[40px] p-4 bg-[#F9FFF2]">
                ...
                >
                  <CardCurriculum  
                  curriculumNo="01"
                  curriculum={maktab_nazirah_foundation} />
                   {/* <CardCurriculum 
                   curriculumNo="2"
                   curriculum={nazirah_hifz_continuation} /> */}
