...
export default function LossAndFoundSection({ losses, founds, loading, lostListRef, foundListRef }) {
    return (
        <div className='borderDonationHome rounded-[20px] px-3 sm:px-4 md:px-8 py-8'>
            <div className='border-b border-b-[#B0C4B8] mb-6 pb-3'>
                ...
                <p className='text-[#000000] text-center text-sm sm:text-base my-1 '>If you lost or found something, please report it below. We’ll help you reconnect with your belongings.</p>
            </div>

            <div className='space-y-6 md:space-y-14'>
                <div ref={lostListRef} className="scroll-mt-32">
                    <LostItemList data={losses} loading={loading} />
                </div>
                <div ref={foundListRef} className="scroll-mt-32">
