...
//     <p style={{ fontSize: '14px', color: '#3E8B18', lineHeight: '1.2', margin: '2px 0 0 0' }}>{value || "—"}</p>
//   </div>
// );
...
//           style={{ width: '44%', display: 'flex', flexDirection: 'column', justify: 'space-between', paddingRight: '16px' }}>
//           {/* Top: Obituary */}
//           <div style={{ textAlign: 'center' }}>
//             <p
//               className='mb-0.5'
//               style={{ fontSize: '20px', color: '#64A445', lineHeight: '1.2', }}
//             >計報</p>
//             <h2

//               style={{
//                 fontSize: '24px', fontWeight: 'bold', color: '#B98C20', letterSpacing: '0.05em',
...
//             <div
//               className=''
//               style={{ flex: 1, height: '1px', backgroundColor: '#999999' }} />
//             <div style={{
...
//               className=''
//               style={{
//                 fontSize: '23px', fontWeight: 'bold', color: '#B98C20', letterSpacing: '0.05em',
//                 lineHeight: '1.2', margin: '0 0 8px 0'
//               }}
...
//               <span
//                 key={index}
//                 style={{ fontSize: '12px', fontWeight: 'bold', color: '#333333', lineHeight: '14px', textAlign: 'center' }}
//               >
//                 {char === "" ? "\u00A0" : char}
//               </span>
//             ))}
...
//               <span
//                 key={index}
//                 style={{ fontSize: '15px', fontWeight: 'bold', color: '#333333', lineHeight: '22px', textAlign: 'center' }}
//               >
//                 {char}
//               </span>
//             ))}
...
//             <h2
//               style={{
//                 fontSize: '22px', fontWeight: 'bold', color: '#B98C20', letterSpacing: '0.05em',
//                 lineHeight: '1.2', margin: '0 0 8px 0'
//               }}
//             >
...
//             <p
//               style={{ fontSize: '12px', color: '#828282', lineHeight: '1.2', margin: 0 }}
//             >
//               証明書番号
//             </p>
...
//             style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', columnGap: '16px', rowGap: '6px', flex: 1 }}
//           >
//             <FieldBlock
//               labelJp="故人氏名"
