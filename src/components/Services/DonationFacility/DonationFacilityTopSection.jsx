                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    >
                        <p className="text-[#B98C20] text-base mt-2">
                            A dedicated facility provided by Osaka Masjid to support other
                            masajid in collecting their community donations.
                        </p>
                    ...
                    >
                        {[
                            { icon: "1.svg", label: "Donation Booking List" },
                            { icon: "3.svg", label: "Donation History Record" },
                            { icon: "2.svg", label: "Donation Policies" },
                        ].map((item, i) => (
                            <motion.div
                                key={i}
